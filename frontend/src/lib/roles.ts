...
export const PERMISSION_MATRIX: PermissionRow[] = [
  ...
  { label: "Créer une réservation / encaisser (KARN3T)", boss: true, gerant: true, staff: true },
  { label: "Ajouter ou tarifer une ressource (KARN3T)", boss: true, gerant: true, staff: false },
