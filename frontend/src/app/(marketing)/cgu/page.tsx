...
export default function CguPage() {
  return <LegalLayout title="Conditions Générales d’Utilisation">
    <h2>1. Objet</h2>
    <p>Les présentes CGU encadrent l’accès et l’utilisation de R3NS3IGN3M3NT, produit conçu et édité par <strong>AKATech Studio</strong>, entreprise digitale basée à Abidjan, Côte d’Ivoire. Contact : <a href="mailto:wthomasss06@gmail.com">wthomasss06@gmail.com</a> — <a href="tel:+2250142507750">+225 01 42 50 77 50</a>.</p>

    <h2>2. Comptes, rôles et invitations</h2>
    <ul><li>L’authentification des membres de l’établissement se fait exclusivement avec Google. Aucun mot de passe R3NS3IGN3M3NT n’est créé.</li><li>Le Patron crée et administre l’espace de son établissement. Il peut configurer le formulaire, gérer le QR Code, inviter les membres et exporter le registre.</li><li>Le Gérant dispose des droits opérationnels nécessaires au fonctionnement quotidien, sans accès aux actions sensibles réservées au Patron.</li><li>Le Staff consulte le registre et utilise le mode Accueil / tablette, sans pouvoir modifier la configuration de l’établissement.</li><li>Le rattachement à une entreprise se fait par invitation et correspondance avec l’adresse Google invitée. Aucun utilisateur ne peut s’attribuer un rôle lui-même.</li></ul>
