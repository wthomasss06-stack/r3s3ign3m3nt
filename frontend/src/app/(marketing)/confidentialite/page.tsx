...
export default function ConfidentialitePage() {
  return <LegalLayout title="Politique de confidentialité">
    ...
    <h2>Cookies et stockage local</h2><p>Un cookie de session strictement nécessaire peut être utilisé pour maintenir la connexion des membres. L’interface visiteur utilise le stockage local du navigateur pour le mode offline et la file de synchronisation. Aucun cookie publicitaire n’est nécessaire au fonctionnement du service.</p>
    ...
    <h2>Droits des personnes</h2><p>Selon la réglementation applicable, les personnes peuvent demander l’accès, la rectification ou la suppression de leurs données. La demande doit être adressée en priorité à l’établissement qui a collecté les informations. Pour contacter AKATech Studio : <a href="mailto:wthomasss06@gmail.com">wthomasss06@gmail.com</a> ou <a href="tel:+2250142507750">+225 01 42 50 77 50</a>.</p>
