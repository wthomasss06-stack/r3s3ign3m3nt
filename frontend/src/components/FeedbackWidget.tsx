...
export default function FeedbackWidget() {
  ...
  return <div className="fixed bottom-5 right-5 z-50">
    ...
    <button onClick={() => { setOpen((value) => !value); setState("idle"); }} className="flex items-center gap-2 rounded-full bg-cta px-4 py-3 text-sm font-semibold text-white shadow-xl transition hover:-translate-y-0.5 hover:bg-cta-hover" aria-label="Donner un feedback"><ChatCircleDots size={20} weight="bold" /> Feedback</button>
  </div>;
}
