...
export default function Sidebar({ orgName, orgLogo = "", userName = "", userAvatar = "", role }: { orgName: string; orgLogo?: string; userName?: string; userAvatar?: string; role: AccountRole }) {
  ...
  const links = role === "STAFF"
    ...
    : [{ href: "/dashboard", label: "Registre", icon: ClipboardText, exact: true }, { href: "/dashboard/accueil", label: "Accueil", icon: House, exact: true }, { href: "/dashboard/parametres", label: "Paramètres", icon: GearSix, exact: false }];
