...
export default function Sidebar({ orgName, orgLogo = "", userName = "", role }: { orgName: string; orgLogo?: string; userName?: string; role: AccountRole }) {
